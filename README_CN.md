...
一个用于从 OpenAPI 3.0 文档自动生成 TypeScript 或 JavaScript 接口代码的命令行工具。

## ✨ 特性

- 🚀 **快速生成** - 从 OpenAPI 3.0 JSON 或 YAML 快速生成 TypeScript 接口代码
...
| `input`                  | string                | -              | OpenAPI 3.0 JSON/YAML 文件路径或 URL，自动打包本地或远程外部 `$ref` 引用                                                         |
